# Generated by Django 4.2.17 on 2024-12-23 02:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Waiting', 'Waiting'), ('In_progress', 'In_progress'), ('Completed', 'Completed')], default='Waiting', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gameApp.gamesession')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_reason', models.CharField(choices=[('Waiting', 'Waiting'), ('In_progress', 'In_progress'), ('Completed', 'Completed')], default='Completed', max_length=16)),
