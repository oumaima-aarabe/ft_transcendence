  ...
  return (
    <Card className="w-full max-w-lg bg-[#751d03] bg-opacity-[18%] p-6 md:p-10 flex flex-col rounded-3xl border-none backdrop-blur-lg">
      <div className="flex flex-col justify-center items-center h-auto p-4 text-white text-center space-x-2 space-y-2">
          <p className="text-3xl font-bold">Two factor authentication</p>
          <p className="text-xl inline-block text-[#40CFB7]">Enter the code generated by your authenticator app to continue</p>
      </div>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="flex flex-col space-y-2">
            <label className="text-white text-sm pl-2" htmlFor="code">Enter your 2fa code</label>
            <input 
        ...
        <div className="flex items-center w-full">
          ...
          <p className="text-sm text-white mx-4">Or</p>
          <div className="border-t-2 border-[#40CFB7] flex-grow"></div>
        </div>
