...
interface TournamentsOptionsProps {
  onSelectMode: (mode: 'join' | 'create') => void;
}

export default function TournamentsPage({ onSelectMode }: TournamentsOptionsProps) {
  ...
  const options = [
    {
      ...
      clickHandler: () => onSelectMode('join')
    },
    {
      id: 'create',
      title: t('create'),
      ...
      clickHandler: () => onSelectMode('create')
    }
  ];
