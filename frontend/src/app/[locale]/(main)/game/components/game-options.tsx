...
import FriendGameInvites from './InviteFriendGame';
...
const GameOptions: React.FC<GameOptionsProps> = ({ onSelectMode }) => {
  ...
  // Handle back from friend invites
  const handleBackFromInvites = () => {
  ...
  return (
    <AnimatePresence mode="wait">
      {showFriendInvites ? (
        ...
        >
          <FriendGameInvites onBack={handleBackFromInvites} />
        </motion.div>
      ) : (
        <motion.div
          key="game-options"
